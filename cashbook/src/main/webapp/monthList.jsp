      ...
      <% for (ReportData r : usageList) { %>
        <div class="col d-flex justify-content-between align-items-center">
          <div class="d-flex align-items-center gap-2">
            <span style="width: 8px; height: 8px; background-color: black; border-radius: 50%; display:inline-block;"></span>
            <span class="summary-tag" style="background-color: <%= r.getColor() %>;">
              <%= r.getTitle() %>
            </span>
          </div>
          <div class="<%= "지출".equals(r.getKind()) ? "text-danger" : "text-success" %> fw-semibold text-small">
...
<div class="container-box">
  ...
  <div class="text-end mb-3">
    <a href="insertCashForm.jsp" class="btn btn-yellow btn-sm">
    ...
    <tbody>
      <%
        ...
        for (int date = 1; date <= lastDate; date++) {
          if (cellCount % 7 == 0 && cellCount != 0) out.println("</tr><tr>");
          ...
          if (list != null) {
            for (Cash c : list) {
              ...
              out.println(c.getCategoryTitle() + "</span> ");
              out.println("<span class='text-small'>");
              out.println(c.getMemo() + " : ￦" + c.getPrice() + "</span>");
              out.println("</div>");
            }
          }
